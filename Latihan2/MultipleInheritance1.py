...
mhs_pekerja = MahasiswaPekerja("Ajeng", "190001", "Programmer")
mhs_pekerja.belajar() # output: Ajeng sedang belajar
mhs_pekerja.bekerja() # output: Ajeng sedang bekerja
mhs_pekerja.bersosialisasi() # output: Ajeng sedang bersosialisasi